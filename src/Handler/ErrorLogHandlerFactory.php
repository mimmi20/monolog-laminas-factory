...
final class ErrorLogHandlerFactory implements FactoryInterface
{
     ...
     * @phpstan-param array{messageType?: (ErrorLogHandler::OPERATING_SYSTEM|ErrorLogHandler::SAPI), level?: (string|LogLevel::*), bubble?: bool, expandNewlines?: bool}|null $options
     *
